...
Week 1 focuses on creating a complete data pipeline that collects, processes, and merges multi-source environmental data for 10 major Indian cities.
...
File Name: final_combined_dataset.csv

Location: data/processed/

Dataset Includes:

Pollution indicators (pivoted format)
